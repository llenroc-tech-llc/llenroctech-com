...
describe('portfolio content',()=>{
  ...
  it('links to the live enterprise customer platform',()=>{const project=PORTFOLIO_PROJECTS.find(x=>x.id==='enterprise-customer-platform');expect(project?.status).toBe('Live');expect(project?.liveUrl).toBe('https://customerconnect.llenroctech.com/');});

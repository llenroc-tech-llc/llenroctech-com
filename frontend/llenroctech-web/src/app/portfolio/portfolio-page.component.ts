...
export class PortfolioPageComponent implements OnInit,OnDestroy {
  readonly featured=PORTFOLIO_PROJECTS.filter(x=>x.section==='featured'); readonly innovation=PORTFOLIO_PROJECTS.filter(x=>x.section==='innovation'); readonly technologies=TRUSTED_TECHNOLOGIES;

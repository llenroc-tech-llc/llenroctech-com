...
export class FeaturedWorkComponent { readonly projects=PORTFOLIO_PROJECTS.filter(x=>['customerconnect','robot-mower','push-up-sit-up-365','reddick-foundation'].includes(x.id)); }
